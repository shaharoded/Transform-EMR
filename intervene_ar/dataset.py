...
class DataProcessor:
    ...
    def _expand_tokens(self, min_interval_duration_sec=1):
        ...
        #   - intervene_ar/utils.py::get_temporal_multi_hot_targets()
        #   - intervene_ar/embedder.py::train_embedder() BCE loss computation
        #   - intervene_ar/transformer.py::pretrain_transformer() BCE loss computation
        #
